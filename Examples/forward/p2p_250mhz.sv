...
module p2p_250mhz #(
  ...
  //signal for instance 1
  wire                    s_axil_awready_0;
  wire                    s_axil_wready_0;
  wire                    s_axil_bvalid_0;
  wire              [1:0] s_axil_bresp_0;
  wire                    s_axil_arready_0;
  wire                    s_axil_rvalid_0;
  wire             [31:0] s_axil_rdata_0;
  wire              [1:0] s_axil_rresp_0;

    //signal for instance 2
  wire                    s_axil_awready_1;
  wire                    s_axil_wready_1;
  wire                    s_axil_bvalid_1;
  wire              [1:0] s_axil_bresp_1;
  wire                    s_axil_arready_1;
  wire                    s_axil_rvalid_1;
  wire             [31:0] s_axil_rdata_1;
  wire              [1:0] s_axil_rresp_1;
  ...
  generate for (genvar i = 0; i < NUM_INTF; i++) begin
    ...
    if (i==0) begin
      vitis_net_p4_0 forward_p4 (
        ...
        .s_axi_arready   (s_axil_arready_0),                      // output wire s_axi_arready
        .s_axi_arvalid   (s_axil_arvalid),                      // input wire s_axi_arvalid
        .s_axi_awaddr    (s_axil_awaddr),                       // input wire [12 : 0] s_axi_awaddr
        .s_axi_awready   (s_axil_awready_0),                      // output wire s_axi_awready
        .s_axi_awvalid   (s_axil_awvalid),                      // input wire s_axi_awvalid
        .s_axi_bready    (s_axil_bready),                       // input wire s_axi_bready
        .s_axi_bresp     (s_axil_bresp_0),                        // output wire [1 : 0] s_axi_bresp
        .s_axi_bvalid    (s_axil_bvalid_0),                       // output wire s_axi_bvalid
        .s_axi_rdata     (s_axil_rdata_0),                        // output wire [31 : 0] s_axi_rdata
        .s_axi_rready    (s_axil_rready),                       // input wire s_axi_rready
        .s_axi_rresp     (s_axil_rresp_0),                        // output wire [1 : 0] s_axi_rresp
        .s_axi_rvalid    (s_axil_rvalid_0),                       // output wire s_axi_rvalid
        .s_axi_wdata     (s_axil_wdata),                        // input wire [31 : 0] s_axi_wdata
        .s_axi_wready    (s_axil_wready_0),                       // output wire s_axi_wready
        .s_axi_wstrb     (4'b1111),                             // input wire [3 : 0] s_axi_wstrb
        .s_axi_wvalid    (s_axil_wvalid)                        // input wire s_axi_wvalid
      );

      //vitis net p4  IP instance 2

      end else if (i==1) begin
            vitis_net_p4_1 forward_p4 (
        .s_axis_aclk     (axis_aclk),                         // input wire s_axis_aclk
        .s_axis_aresetn  (axis_aresetn),                      // input wire s_axis_aresetn
        .s_axi_aclk      (axil_aclk),                         // input wire s_axi_aclk
        .s_axi_aresetn   (axil_aresetn),                      // input wire s_axi_aresetn
        ...
        .m_axis_tready   (m_axis_qdma_c2h_tready[i]),                     // input wire m_axis_tready
        .s_axi_araddr    (s_axil_araddr),                       // input wire [12 : 0] s_axi_araddr
        .s_axi_arready   (s_axil_arready_1),                      // output wire s_axi_arready
        .s_axi_arvalid   (s_axil_arvalid),                      // input wire s_axi_arvalid
        .s_axi_awaddr    (s_axil_awaddr),                       // input wire [12 : 0] s_axi_awaddr
        .s_axi_awready   (s_axil_awready_1),                      // output wire s_axi_awready
        .s_axi_awvalid   (s_axil_awvalid),                      // input wire s_axi_awvalid
        .s_axi_bready    (s_axil_bready),                       // input wire s_axi_bready
        .s_axi_bresp     (s_axil_bresp_1),                        // output wire [1 : 0] s_axi_bresp
        .s_axi_bvalid    (s_axil_bvalid_1),                       // output wire s_axi_bvalid
        .s_axi_rdata     (s_axil_rdata_1),                        // output wire [31 : 0] s_axi_rdata
        .s_axi_rready    (s_axil_rready),                       // input wire s_axi_rready
        .s_axi_rresp     (s_axil_rresp_1),                        // output wire [1 : 0] s_axi_rresp
        .s_axi_rvalid    (s_axil_rvalid_1),                       // output wire s_axi_rvalid
        .s_axi_wdata     (s_axil_wdata),                        // input wire [31 : 0] s_axi_wdata
        .s_axi_wready    (s_axil_wready_1),                       // output wire s_axi_wready
        .s_axi_wstrb     (4'b1111),                             // input wire [3 : 0] s_axi_wstrb
        .s_axi_wvalid    (s_axil_wvalid)                        // input wire s_axi_wvalid
      );
  ...
  //assign outputs
assign s_axil_awready = (enable == 0) ? s_axil_awready_0 : s_axil_awready_1;
assign s_axil_wready = (enable == 0) ? s_axil_wready_0 : s_axil_wready_1;
assign s_axil_bvalid = (enable == 0) ? s_axil_bvalid_0 : s_axil_bvalid_1;
assign s_axil_bresp = (enable == 0) ? s_axil_bresp_0 : s_axil_bresp_1;
assign s_axil_arready = (enable == 0) ? s_axil_arready_0 : s_axil_arready_1;
assign s_axil_rvalid = (enable == 0) ? s_axil_rvalid_0 : s_axil_rvalid_1;
assign s_axil_rdata = (enable == 0) ? s_axil_rdata_0 : s_axil_rdata_1;
assign s_axil_rresp = (enable == 0) ? s_axil_rresp_0 : s_axil_rresp_1;
